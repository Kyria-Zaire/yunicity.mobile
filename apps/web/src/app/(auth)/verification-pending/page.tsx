...
export default function VerificationPendingPage() {
  ...
  return (
    <div className="max-w-lg w-full text-center">
      ...
      <p className="font-body text-base text-[#6B7280] mt-4 leading-relaxed">
        Notre équipe vérifie votre profil. Vous serez opérationnel sous <strong className="text-[#0D0F2E] font-semibold">24 h</strong>.
      </p>
          ...
          <ul className="space-y-8 relative">
            ...
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#6B7280]">Votre adresse email est bien confirmée.</p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                <p className="font-body text-sm font-medium text-[#0D0F2E]">Documents KYC en cours de vérification</p>
      ...
      <div className="mt-10 rounded-xl bg-[#E8E9FF]/80 border-l-4 border-[#2A2FFF] px-5 py-4 text-left">
        ...
        <Link href="/map" className="inline-block mt-3 text-sm font-semibold text-[#2A2FFF] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2A2FFF] rounded">
          Explorer la carte →
        </Link>
      </div>
